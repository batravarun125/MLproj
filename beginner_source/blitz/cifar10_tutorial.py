...
"""
import numpy
from py2app.recipes import matplotlib
...
# network and optimize.
    ...
    print c
    print('Accuracy of the network on the 10000 test images: %d %% %d' % (
    ...
    print('Accuracy of the network on the 50000 train images: %d %% %d' % (
        100 * correct / total, total))
    ########################################################################
